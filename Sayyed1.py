...
def banner():
    ...
    runntxt(WW+"   ..................  H0w ar3 y0u all fr1nds")
    runntxt(WW+"     ....      Fr0m 5-Z4K4RY4")
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: S-Z4K4RY4                |"
    print GL+"  |              1 L0V3 H4CK1NG                 |"
    print WW+"  |        Facebook : Sayyed Zakarya Bacha      |"
    print Y+"  |             YouTube: Aryano Tricks           |"
    print GL+"  |---------------------------------------------|"
        ...
        -o:  -.......        ..       `:o-
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
              `-/+///..````..://+/-`
                  `.-::////::-.` \033[91;1m
                \033[90;1m1 L0V3 H4CK1NG\033[91;1m
             Powered by:\033[97m S-Z4K4RY4
      """
